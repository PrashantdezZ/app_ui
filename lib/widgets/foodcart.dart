      ...
      decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              ...
              spreadRadius: 0,
              blurRadius: 3,
              color: const Color.fromRGBO(87, 87, 87, 1).withOpacity(0.25),
            ),
          ]),
      child: Row(
        children: [
                  ...
                  Column(
                    children: [
                      ...
                      SizedBox(
                        ...
                        width: 120,
                        child: Text(
                          '1 kacchi biryani,1 Pepsi,chili onion,1kachhi biryani,1Pepsi chili',
                          softWrap: true,
                          style: GoogleFonts.tajawal(
                              fontWeight: FontWeight.w400,
                              fontSize: 14,
                      ...
                      decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              ...
                              spreadRadius: 0,
                              blurRadius: 14,
                              color: const Color.fromRGBO(245, 90, 81, 1)
                                  .withOpacity(0.08),
                            ),
                            BoxShadow(
